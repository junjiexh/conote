...
const (
	...
	AccountService_ConfirmPasswordReset_FullMethodName = "/account.AccountService/ConfirmPasswordReset"
	AccountService_GetUser_FullMethodName              = "/account.AccountService/GetUser"
	AccountService_UpdateUser_FullMethodName           = "/account.AccountService/UpdateUser"
)
...
type AccountServiceClient interface {
	...
	ConfirmPasswordReset(ctx context.Context, in *PasswordResetConfirmRequest, opts ...grpc.CallOption) (*PasswordResetConfirmResponse, error)
	// User Management
...
func (c *accountServiceClient) RequestPasswordReset(ctx context.Context, in *PasswordResetRequest, opts ...grpc.CallOption) (*PasswordResetResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *accountServiceClient) ConfirmPasswordReset(ctx context.Context, in *PasswordResetConfirmRequest, opts ...grpc.CallOption) (*PasswordResetConfirmResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(PasswordResetConfirmResponse)
...
type AccountServiceServer interface {
	...
	ConfirmPasswordReset(context.Context, *PasswordResetConfirmRequest) (*PasswordResetConfirmResponse, error)
	// User Management
...
func (UnimplementedAccountServiceServer) RequestPasswordReset(context.Context, *PasswordResetRequest) (*PasswordResetResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RequestPasswordReset not implemented")
}
func (UnimplementedAccountServiceServer) ConfirmPasswordReset(context.Context, *PasswordResetConfirmRequest) (*PasswordResetConfirmResponse, error) {
...
func _AccountService_ConfirmPasswordReset_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AccountServiceServer).ConfirmPasswordReset(ctx, req.(*PasswordResetConfirmRequest))
	}
	return interceptor(ctx, in, info, handler)
}
